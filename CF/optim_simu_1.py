...
#         coord_list = np.array(coord_list.collect())
        ...
        print("get output_array: ", output_array.shape) # (2, 17) # need (n,46)
...
#         print("age_array: ", age_array)
        ...
        if count % 10 == 0:
            ...
            np.savetxt('sim_out_daily_RF_CF_spark_optim'+ str(count) + '.txt', t_output_array, delimiter=',', fmt='%1.4f,%1.4f')
#         #if count == 10:
#             #break
        index += 1
