...
parser.add_argument('--data_dir', default='data/GALLUP', help="Directory containing the dataset")
...
def train(model, optimizer, loss_fn, data_iterator, metrics, params, num_steps):
    ...
    for i in t:
        ...
        #print("training-get train_batch, label_batch")
        # compute model output and loss
        #print(train_batch.type())
        output_batch = model(train_batch.float())
        #print("get output_batch")
...
if __name__ == '__main__':
    ...
    data_json_path = os.path.join(args.data_dir, 'dataset_params.json')
    data_params = utils.Params(data_json_path)
